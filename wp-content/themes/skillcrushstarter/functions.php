...
function skillcrushstarter_add_more_to_custom_excerpt($excerpt) {
	return $excerpt . '<div class="read-more"><a href="'. get_permalink() . '"><span>Read more</span> &raquo;</a></div>';

}
add_filter('get_the_excerpt', 'skillcrushstarter_add_more_to_custom_excerpt');
